...
public class Ejecutable {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Creo un array que almacena 10 objetos de tipo Electrodomestico, el cual,
         * llenamos con articulos de la super clase y sus dos clases hijas.
         */
        ...
        /**
         * definimos parametros que almacenaran los valores totales de los objetos por
         * clase.
         */
        ...
        /**
         * Recorre el arreglo en su totalidad. Aplica el metodo de la super clase
         * precioFinal Diferenciado por clase.
         */

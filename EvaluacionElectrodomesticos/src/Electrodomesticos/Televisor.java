...
public class Televisor extends Electrodomestico {
     ...
     * @param sintonizadorTDT
     */
    public Televisor(float precioBase, Float peso, String color, char consumoEnergetico, int pulgadas,
    ...
    /**
     * Adiciona valores en base a la carga del objeto. Metodo heredado de Super
